      ...
      <Table sx={{ minWidth: 600 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">נוצר לפני</TableCell>
            ...
            >
              {props.type === "user" ? (
                <TableCell component="th" scope="row">
                  ...
                  <img
                    className="cellImg"
                    src={row?.productId?.images[0] || bikeImage}
                    alt="img"
                  />
                </TableCell>
              ) : (
              ...
              {row.status === "reject" ? (
                <TableCell className="viewButtonReject" align="right">
                  נדחה
                </TableCell>
              ) : props.status === "approve" ? (
                <TableCell className="viewButtonApprove" align="right">
                  אושר
                </TableCell>
              ) : (
                <TableCell className="viewButtonPending" align="right">
                  ..ממתין
                </TableCell>
              )}
            </TableRow>
